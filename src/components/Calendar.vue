...
<v-menu
      ...
      >
        <v-card min-width="250">
          ...
          <v-card-text>
            TODO: add times, location, more details
          </v-card-text>
        </v-card>
      </v-menu>
...
function getEvents() {
  events.value = [
    {
      title: 'Trash hunt with Philippine Navy @ HQ to Lingsat SFC',
      start: new Date(2025, 7, 19, 5, 30),
      end: new Date(2025, 7, 19, 6, 30),
      color: 'blue',
    },
    {
      title: 'Coastal cleanup @ brgy Cabarsican, Bacnotan LU',
    ...
    {
      title: 'Blood letting @ Mess Hall, Wallace Air Station, Poro SFC',
